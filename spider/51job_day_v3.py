...
day_url = '040000,000000,0000,00,0,99,%25E5%25A4%2596%25E8%25B4%25B8'
...
class SpiderDomainInfo(object):
    ...
    def start_spider(self):
        try:
            ...
            res = self.session.get(
                'https://search.51job.com/list/' + day_url + ',2,1.html',
    ...
    def next_page(self, page):
        try:
            ...
            res = self.session.get(
                'https://search.51job.com/list/' + day_url + ',2,' + str(
                    page) + '.html',
                data=boss_params_search,
                headers=search_header,
                proxies=None,
    ...
    def entrance(self):
        try:
            ...
            if self.pages > 1:
                ...
                for i in range(self.pages, self.pages+1):
                    if i % 100 == 0:
